...
export default function Page() {
  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-7xl flex-col gap-8 px-5 pb-20 md:px-8">
      <DashboardHeader onSearch={startAnalysis} isStreaming={isStreaming} />
